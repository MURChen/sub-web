              ...
              <div v-if="advanced === '2'">
                <el-form-item label="后端地址:">
                  <el-autocomplete
                    ...
                    placeholder="http://192.168.3.40:25000/sub?"
                  >
  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "http://192.168.3.40:25000/sub?" }],
        remoteConfig: [
          {
            label: "universal",
            options: [
              {
                label: "Myself",
                value:
                  "https://raw.githubusercontent.com/MURChen/subconverter/master/MURC/Myself.ini"
              },
              {
                label: "No-Urltest",
                value:
